<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="registo.aspx.cs" Inherits="UFCD_9952_TrabalhoModelo_2021_22.registo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Registo</h1>
    <asp:FormView Width="100%" ID="FormView1" DefaultMode="Insert" runat="server" DataKeyNames="ID" DataSourceID="SqlUtilizadores">
        <EditItemTemplate>
            ID:
        ...
        <InsertItemTemplate>
            ...
            <asp:LinkButton CssClass="btn btn-danger" runat="server" Text="Registar" CommandName="Insert" ID="InsertButton" CausesValidation="True" />&nbsp;           
            <a class="btn btn-primary" href="Index.aspx">Voltar</a>
        </InsertItemTemplate>
        <ItemTemplate>
            ID:
    ...
    <asp:SqlDataSource runat="server" ID="SqlUtilizadores"
        ...
        InsertCommand="INSERT INTO [Utilizadores] ([Nome], [Morada], [CP], [CC], [NIF], [Data_Nascimento], [Nr_Telefone], [Email], [Password]) VALUES (@Nome, @Morada, @CP, @CC, @NIF, @Data_Nascimento, @Nr_Telefone, @Email, HASHBYTES('SHA2_512',@Password))"
